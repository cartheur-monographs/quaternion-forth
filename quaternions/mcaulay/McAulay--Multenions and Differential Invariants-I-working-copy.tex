...
$\breve{\iota}$, $\breve{\sigma}$, $\breve{\beta}$, $\breve{\upsilon}$, $\breve{\omega}$.
...
\begin{equation}i_4=\mathfrak J\iota,\tag{7}\end{equation}
and drop out of most of our subsequent work all reference to the original $i_4$ and $\mathfrak J$, using $\iota$ instead with its property $\iota^2=1$, as opposed to $i_4^2=-1$. Questions in relativity are then treated by aid of the multiplicative combinations of such expressions as
\begin{equation}xi_1+yi_2+zi_3+t\iota.\tag{8}\end{equation}
...
when $\iota$ is any product of our \emph{original} generators $i_1$, $i_2$, \ldots{} $i_n$. This ceases to be true when $\iota$ takes the place of $i_4$, simply because $\mathfrak J^{-1}$ is $-\mathfrak J$ and not $+\mathfrak J$. It may be noted, however, that there is always a reproscriptive $K\phi=R$ to be found, which is such that for every semi-real vectorium $\breve\iota$, $R\breve\iota=\breve\iota^{-1}$.
