...
V_0d\breve p_2V_2\nabla\chi'\gamma,
\]
or since $d\breve\rho_2$ is arbitrary,
...
\newpage\thispagestyle{empty}\begin{center}324\hfill Prof.\ A.\ McAulay.\end{center}
...
\vspace{1.5cm}
\begin{center}\rule{0.28\textwidth}{0.8pt}\end{center}
