...
\begin{equation}2\Psi_{\beta\gamma}=-\lambda V_0\beta\eta\gamma+2\mathfrak{T}_{\beta\gamma}.\tag{5}\end{equation}
where $\lambda$ is a covariant vector (namely, $2n^{-1}\Psi_{\zeta\eta^{-1}\zeta}$), and $\mathfrak{T}_{\beta\gamma}$ is a covariant vector, linear and symmetrical in $\beta$ and $\gamma$, and satisfying the vector equation
\begin{equation}\mathfrak{T}_{\zeta\eta^{-1}\zeta}=0.\tag{6}\end{equation}
...
\begin{center}\rule{2.5in}{0.4pt}\end{center}
\end{document}
