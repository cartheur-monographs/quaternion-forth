...
where, as in Quaternions, $\theta\Pi$ means the self-conjugate linity differential operator given by
\begin{equation}
  df=-V_0d\theta\zeta\,\theta\Pi f\zeta
  \tag{20}
\end{equation}
...
\begin{equation}
  T^{\bullet(t)}=T^\bullet+2\theta_\theta\Pi f
  \tag{21}
\end{equation}
...
\[
  ...
  =V_0\omega^\times\delta\dot\omega'-V_0\delta\theta\zeta\,\theta\Pi f\zeta.
\]
...
\begin{equation}
  \begin{aligned}
    ...
    &\quad+V_0\bigl(2\epsilon_9\theta_\theta\Pi f\nabla_9-\epsilon\Pi f\zeta\theta_9\zeta\mathbin{\cdot}V_0\epsilon\nabla_9\bigr).
  \end{aligned}
  \tag{24}
\end{equation}
...
\[
  \nabla f=\nabla_9V_0\dot\omega'_9\omega^\times-\nabla_9V_0\theta_9\zeta\,\theta\Pi f\zeta.
\]
