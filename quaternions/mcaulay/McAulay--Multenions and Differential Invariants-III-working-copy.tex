...
\]
I think there can be no doubt that this amendment is the true expression for the force, cum power, per unit volume. It will be observed that no change occurs in the total energy linity $T^{\bullet(t)}=T^\bullet+2\thetaPi f$.
