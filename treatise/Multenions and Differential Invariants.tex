...
\newpage\thispagestyle{empty}\begin{center}\textit{Multenions and Differential Invariants.}\hfill 323\end{center}
...
\ifdefined\unifiedtreatise\else
...
\newpage\thispagestyle{empty}\begin{center}\textit{Multenions and Differential Invariants.}\hfill 237\end{center}
...
\newpage\thispagestyle{empty}\begin{center}238\hfill Prof.\ A.\ McAulay.\end{center}
...
\newpage\thispagestyle{empty}\begin{center}\textit{Multenions and Differential Invariants.}\hfill 239\end{center}
...
\newpage\thispagestyle{empty}\begin{center}240\hfill\textit{Multenions and Differential Invariants.}\end{center}
